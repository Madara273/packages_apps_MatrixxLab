...
class TrickyStore : SettingsPreferenceFragment() {
    ...
    private val isOfficialBuild: Boolean
        get() = android.os.SystemProperties.get("ro.matrixx.release.type", "") == "OFFICIAL"
    ...
    companion object {
        ...
        private const val OFFICIAL_KEYBOX_URL =
            "https://raw.githubusercontent.com/ProjectMatrixx/vendor_certification/refs/heads/16.2/keybox.xml"
