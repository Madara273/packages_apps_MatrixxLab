...
import com.matrixx.settings.fragments.misc.TrickyStore
...
class PlayIntegrityFix : SettingsPreferenceFragment() {
    ...
    companion object {
        ...
        private const val FALLBACK_PIF_URL = "https://raw.githubusercontent.com/ProjectMatrixx/vendor_certification/refs/heads/16.2/pif.json"
        ...
        /**
         * Fetches the LUNARIS AOSP hosted pif.json as a fallback when the live
